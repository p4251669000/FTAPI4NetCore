...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class GetUserInfo {
    ...
    static GetUserInfo() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "byIZCgNDMlMSEgoEZmxhZxgCIAEoBVIEZmxhZyLxCQoDUzJDEhoKCG5pY2tO", 
            ...
            "TmV3EigKD3VzSW5kZXhRb3RSaWdodBgVIAEoBVIPdXNJbmRleFFvdFJpZ2h0", 
            "EiQKDXVzT3RjUW90UmlnaHQYFiABKAVSDXVzT3RjUW90UmlnaHQSMAoTdXND", 
            "TUVGdXR1cmVRb3RSaWdodBgXIAEoBVITdXNDTUVGdXR1cmVRb3RSaWdodBIy", 
            "ChR1c0NCT1RGdXR1cmVRb3RSaWdodBgYIAEoBVIUdXNDQk9URnV0dXJlUW90", 
            "UmlnaHQSNAoVdXNOWU1FWEZ1dHVyZVFvdFJpZ2h0GBkgASgFUhV1c05ZTUVY", 
            "RnV0dXJlUW90UmlnaHQSNAoVdXNDT01FWEZ1dHVyZVFvdFJpZ2h0GBogASgF", 
            "UhV1c0NPTUVYRnV0dXJlUW90UmlnaHQSMgoUdXNDQk9FRnV0dXJlUW90Umln", 
            "aHQYGyABKAVSFHVzQ0JPRUZ1dHVyZVFvdFJpZ2h0EioKEHNnRnV0dXJlUW90", 
            "UmlnaHQYHCABKAVSEHNnRnV0dXJlUW90UmlnaHQSKgoQanBGdXR1cmVRb3RS", 
            "aWdodBgdIAEoBVIQanBGdXR1cmVRb3RSaWdodBIgCgtpc0FwcE5OT3JNTRge", 
            "IAEoCFILaXNBcHBOTk9yTU0SHgoKc2hRb3RSaWdodBgfIAEoBVIKc2hRb3RS", 
            "aWdodBIeCgpzelFvdFJpZ2h0GCAgASgFUgpzelFvdFJpZ2h0Ii0KB1JlcXVl", 
            "c3QSIgoDYzJzGAEgAigLMhAuR2V0VXNlckluZm8uQzJTUgNjMnMigAEKCFJl", 
            "c3BvbnNlEh4KB3JldFR5cGUYASACKAU6BC00MDBSB3JldFR5cGUSFgoGcmV0", 
            "TXNnGAIgASgJUgZyZXRNc2cSGAoHZXJyQ29kZRgDIAEoBVIHZXJyQ29kZRIi", 
            "CgNzMmMYBCABKAsyEC5HZXRVc2VySW5mby5TMkNSA3MyYypOCgpVcGRhdGVU", 
            "eXBlEhMKD1VwZGF0ZVR5cGVfTm9uZRAAEhUKEVVwZGF0ZVR5cGVfQWR2aWNl", 
            "EAESFAoQVXBkYXRlVHlwZV9Gb3JjZRACKq4BCg1Vc2VySW5mb0ZpZWxkEhcK", 
            "E1VzZXJJbmZvRmllbGRfQmFzaWMQARIVChFVc2VySW5mb0ZpZWxkX0FQSRAC", 
            "EhoKFlVzZXJJbmZvRmllbGRfUW90UmlnaHQQBBIcChhVc2VySW5mb0ZpZWxk", 
            "X0Rpc2NsYWltZXIQCBIYChRVc2VySW5mb0ZpZWxkX1VwZGF0ZRAQEhkKFFVz", 
            "ZXJJbmZvRmllbGRfV2ViS2V5EIAQQkIKE2NvbS5mdXR1Lm9wZW5hcGkucGJa", 
          "K2dpdGh1Yi5jb20vZnV0dW9wZW4vZnRhcGk0Z28vcGIvZ2V0dXNlcmluZm8="));
    ...
    public sealed partial class S2C : pb::GeneratedMessage<S2C, S2C.Builder> {
      ...
      private static readonly string[] _s2CFieldNames = new string[] { "apiLevel", "avatarUrl", "cnQotRight", "hasUSOptionQotRight", "historyKLQuota", "hkFutureQotRight", "hkOptionQotRight", "hkQotRight", "isAppNNOrMM", "isNeedAgreeDisclaimer", "jpFutureQotRight", "nickName", "sgFutureQotRight", "shQotRight", "subQuota", "szQotRight", "updateType", "updateWhatsNew", "usCBOEFutureQotRight", "usCBOTFutureQotRight", "usCMEFutureQotRight", "usCOMEXFutureQotRight", "usFutureQotRight", "usIndexQotRight", "usNYMEXFutureQotRight", "usOptionQotRight", "usOtcQotRight", "usQotRight", "userAttribution", "userID", "webJumpUrlHead", "webKey" };
      private static readonly uint[] _s2CFieldTags = new uint[] { 26, 18, 48, 96, 120, 104, 88, 32, 240, 56, 232, 10, 224, 248, 112, 256, 72, 162, 216, 192, 184, 208, 128, 168, 200, 136, 176, 40, 152, 64, 146, 82 };
      ...
      public const int UsIndexQotRightFieldNumber = 21;
      ...
      public const int UsOtcQotRightFieldNumber = 22;
      ...
      public const int UsCMEFutureQotRightFieldNumber = 23;
      ...
      public const int UsCBOTFutureQotRightFieldNumber = 24;
      ...
      public const int UsNYMEXFutureQotRightFieldNumber = 25;
      ...
      public const int UsCOMEXFutureQotRightFieldNumber = 26;
      ...
      public const int UsCBOEFutureQotRightFieldNumber = 27;
      ...
      public const int SgFutureQotRightFieldNumber = 28;
      ...
      public const int JpFutureQotRightFieldNumber = 29;
      ...
      public const int IsAppNNOrMMFieldNumber = 30;
      private bool hasIsAppNNOrMM;
      private bool isAppNNOrMM_;
      public bool HasIsAppNNOrMM {
        get { return hasIsAppNNOrMM; }
      }
      public bool IsAppNNOrMM {
        get { return isAppNNOrMM_; }
      }
      
      public const int ShQotRightFieldNumber = 31;
      ...
      public const int SzQotRightFieldNumber = 32;
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasNickName) {
          output.WriteString(1, field_names[11], NickName);
        }
        if (hasAvatarUrl) {
        ...
        if (hasUsQotRight) {
          output.WriteInt32(5, field_names[27], UsQotRight);
        }
        if (hasCnQotRight) {
          output.WriteInt32(6, field_names[2], CnQotRight);
        }
        if (hasIsNeedAgreeDisclaimer) {
          output.WriteBool(7, field_names[9], IsNeedAgreeDisclaimer);
        }
        if (hasUserID) {
          output.WriteInt64(8, field_names[29], UserID);
        }
        if (hasUpdateType) {
          output.WriteInt32(9, field_names[16], UpdateType);
        }
        if (hasWebKey) {
          output.WriteString(10, field_names[31], WebKey);
        }
        ...
        if (hasSubQuota) {
          output.WriteInt32(14, field_names[14], SubQuota);
        }
        if (hasHistoryKLQuota) {
          output.WriteInt32(15, field_names[4], HistoryKLQuota);
        }
        if (hasUsFutureQotRight) {
          output.WriteInt32(16, field_names[22], UsFutureQotRight);
        }
        if (hasUsOptionQotRight) {
          output.WriteInt32(17, field_names[25], UsOptionQotRight);
        }
        if (hasWebJumpUrlHead) {
          output.WriteString(18, field_names[30], WebJumpUrlHead);
        }
        if (hasUserAttribution) {
          output.WriteInt32(19, field_names[28], UserAttribution);
        }
        if (hasUpdateWhatsNew) {
          output.WriteString(20, field_names[17], UpdateWhatsNew);
        }
        if (hasUsIndexQotRight) {
          output.WriteInt32(21, field_names[23], UsIndexQotRight);
        }
        if (hasUsOtcQotRight) {
          output.WriteInt32(22, field_names[26], UsOtcQotRight);
        }
        if (hasUsCMEFutureQotRight) {
          output.WriteInt32(23, field_names[20], UsCMEFutureQotRight);
        }
        if (hasUsCBOTFutureQotRight) {
          output.WriteInt32(24, field_names[19], UsCBOTFutureQotRight);
        }
        if (hasUsNYMEXFutureQotRight) {
          output.WriteInt32(25, field_names[24], UsNYMEXFutureQotRight);
        }
        if (hasUsCOMEXFutureQotRight) {
          output.WriteInt32(26, field_names[21], UsCOMEXFutureQotRight);
        }
        if (hasUsCBOEFutureQotRight) {
          output.WriteInt32(27, field_names[18], UsCBOEFutureQotRight);
        }
        if (hasSgFutureQotRight) {
          output.WriteInt32(28, field_names[12], SgFutureQotRight);
        }
        if (hasJpFutureQotRight) {
          output.WriteInt32(29, field_names[10], JpFutureQotRight);
        }
        if (hasIsAppNNOrMM) {
          output.WriteBool(30, field_names[8], IsAppNNOrMM);
        }
        if (hasShQotRight) {
          output.WriteInt32(31, field_names[13], ShQotRight);
        }
        if (hasSzQotRight) {
          output.WriteInt32(32, field_names[15], SzQotRight);
        }
        UnknownFields.WriteTo(output);
      }
      ...
      private int CalcSerializedSize() {
        ...
        if (hasUsIndexQotRight) {
          size += pb::CodedOutputStream.ComputeInt32Size(21, UsIndexQotRight);
        }
        if (hasUsOtcQotRight) {
          size += pb::CodedOutputStream.ComputeInt32Size(22, UsOtcQotRight);
        }
        if (hasUsCMEFutureQotRight) {
          size += pb::CodedOutputStream.ComputeInt32Size(23, UsCMEFutureQotRight);
        }
        if (hasUsCBOTFutureQotRight) {
          size += pb::CodedOutputStream.ComputeInt32Size(24, UsCBOTFutureQotRight);
        }
        if (hasUsNYMEXFutureQotRight) {
          size += pb::CodedOutputStream.ComputeInt32Size(25, UsNYMEXFutureQotRight);
        }
        if (hasUsCOMEXFutureQotRight) {
          size += pb::CodedOutputStream.ComputeInt32Size(26, UsCOMEXFutureQotRight);
        }
        if (hasUsCBOEFutureQotRight) {
          size += pb::CodedOutputStream.ComputeInt32Size(27, UsCBOEFutureQotRight);
        }
        if (hasSgFutureQotRight) {
          size += pb::CodedOutputStream.ComputeInt32Size(28, SgFutureQotRight);
        }
        if (hasJpFutureQotRight) {
          size += pb::CodedOutputStream.ComputeInt32Size(29, JpFutureQotRight);
        }
        if (hasIsAppNNOrMM) {
          size += pb::CodedOutputStream.ComputeBoolSize(30, IsAppNNOrMM);
        }
        if (hasShQotRight) {
          size += pb::CodedOutputStream.ComputeInt32Size(31, ShQotRight);
        }
        if (hasSzQotRight) {
          size += pb::CodedOutputStream.ComputeInt32Size(32, SzQotRight);
        }
        size += UnknownFields.SerializedSize;
        memoizedSerializedSize = size;
        return size;
      ...
      public sealed partial class Builder : pb::GeneratedBuilder<S2C, Builder> {
        ...
        public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
          ...
          while (input.ReadTag(out tag, out field_name)) {
            ...
            switch (tag) {
              ...
              case 240: {
                result.hasIsAppNNOrMM = input.ReadBool(ref result.isAppNNOrMM_);
                break;
              }
              case 248: {
        ...
        public bool HasIsAppNNOrMM {
          get { return result.hasIsAppNNOrMM; }
        }
        public bool IsAppNNOrMM {
          get { return result.IsAppNNOrMM; }
          set { SetIsAppNNOrMM(value); }
        }
        public Builder SetIsAppNNOrMM(bool value) {
          PrepareBuilder();
          result.hasIsAppNNOrMM = true;
          result.isAppNNOrMM_ = value;
          return this;
        }
        public Builder ClearIsAppNNOrMM() {
          PrepareBuilder();
          result.hasIsAppNNOrMM = false;
          result.isAppNNOrMM_ = false;
          return this;
        }
