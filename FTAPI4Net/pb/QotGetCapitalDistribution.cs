...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class QotGetCapitalDistribution {
    ...
    static QotGetCapitalDistribution() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "Y3VyaXR5UghzZWN1cml0eSKHAwoDUzJDEiYKDmNhcGl0YWxJblN1cGVyGAkg", 
            "ASgBUg5jYXBpdGFsSW5TdXBlchIiCgxjYXBpdGFsSW5CaWcYASACKAFSDGNh", 
            "cGl0YWxJbkJpZxIiCgxjYXBpdGFsSW5NaWQYAiACKAFSDGNhcGl0YWxJbk1p", 
            "ZBImCg5jYXBpdGFsSW5TbWFsbBgDIAIoAVIOY2FwaXRhbEluU21hbGwSKAoP", 
            "Y2FwaXRhbE91dFN1cGVyGAogASgBUg9jYXBpdGFsT3V0U3VwZXISJAoNY2Fw", 
            "aXRhbE91dEJpZxgEIAIoAVINY2FwaXRhbE91dEJpZxIkCg1jYXBpdGFsT3V0", 
            "TWlkGAUgAigBUg1jYXBpdGFsT3V0TWlkEigKD2NhcGl0YWxPdXRTbWFsbBgG", 
            "IAIoAVIPY2FwaXRhbE91dFNtYWxsEh4KCnVwZGF0ZVRpbWUYByABKAlSCnVw", 
            "ZGF0ZVRpbWUSKAoPdXBkYXRlVGltZXN0YW1wGAggASgBUg91cGRhdGVUaW1l", 
            "c3RhbXAiPAoHUmVxdWVzdBIxCgNjMnMYASACKAsyHy5Rb3RfR2V0Q2FwaXRh", 
            "bERpc3RyaWJ1dGlvbi5DMlNSA2MycyKPAQoIUmVzcG9uc2USHgoHcmV0VHlw", 
            "ZRgBIAIoBToELTQwMFIHcmV0VHlwZRIWCgZyZXRNc2cYAiABKAlSBnJldE1z", 
            "ZxIYCgdlcnJDb2RlGAMgASgFUgdlcnJDb2RlEjEKA3MyYxgEIAEoCzIfLlFv", 
            "dF9HZXRDYXBpdGFsRGlzdHJpYnV0aW9uLlMyQ1IDczJjQlAKE2NvbS5mdXR1", 
            "Lm9wZW5hcGkucGJaOWdpdGh1Yi5jb20vZnV0dW9wZW4vZnRhcGk0Z28vcGIv", 
          "cW90Z2V0Y2FwaXRhbGRpc3RyaWJ1dGlvbg=="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Qot_GetCapitalDistribution_S2C__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.QotGetCapitalDistribution.S2C, global::Futu.OpenApi.Pb.QotGetCapitalDistribution.S2C.Builder>(internal__static_Qot_GetCapitalDistribution_S2C__Descriptor,
                new string[] { "CapitalInSuper", "CapitalInBig", "CapitalInMid", "CapitalInSmall", "CapitalOutSuper", "CapitalOutBig", "CapitalOutMid", "CapitalOutSmall", "UpdateTime", "UpdateTimestamp", });
    ...
    public sealed partial class S2C : pb::GeneratedMessage<S2C, S2C.Builder> {
      ...
      private static readonly string[] _s2CFieldNames = new string[] { "capitalInBig", "capitalInMid", "capitalInSmall", "capitalInSuper", "capitalOutBig", "capitalOutMid", "capitalOutSmall", "capitalOutSuper", "updateTime", "updateTimestamp" };
      private static readonly uint[] _s2CFieldTags = new uint[] { 9, 17, 25, 73, 33, 41, 49, 81, 58, 65 };
      ...
      public const int CapitalInSuperFieldNumber = 9;
      private bool hasCapitalInSuper;
      private double capitalInSuper_;
      public bool HasCapitalInSuper {
        get { return hasCapitalInSuper; }
      }
      public double CapitalInSuper {
        get { return capitalInSuper_; }
      }
      ...
      public const int CapitalOutSuperFieldNumber = 10;
      private bool hasCapitalOutSuper;
      private double capitalOutSuper_;
      public bool HasCapitalOutSuper {
        get { return hasCapitalOutSuper; }
      }
      public double CapitalOutSuper {
        get { return capitalOutSuper_; }
      }
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasCapitalOutBig) {
          output.WriteDouble(4, field_names[4], CapitalOutBig);
        }
        if (hasCapitalOutMid) {
          output.WriteDouble(5, field_names[5], CapitalOutMid);
        }
        if (hasCapitalOutSmall) {
          output.WriteDouble(6, field_names[6], CapitalOutSmall);
        }
        if (hasUpdateTime) {
          output.WriteString(7, field_names[8], UpdateTime);
        }
        if (hasUpdateTimestamp) {
          output.WriteDouble(8, field_names[9], UpdateTimestamp);
        }
        if (hasCapitalInSuper) {
          output.WriteDouble(9, field_names[3], CapitalInSuper);
        }
        if (hasCapitalOutSuper) {
          output.WriteDouble(10, field_names[7], CapitalOutSuper);
        }
        UnknownFields.WriteTo(output);
      }
      ...
      private int CalcSerializedSize() {
        ...
        size = 0;
        if (hasCapitalInSuper) {
          size += pb::CodedOutputStream.ComputeDoubleSize(9, CapitalInSuper);
        }
        if (hasCapitalInBig) {
        ...
        if (hasCapitalOutSuper) {
          size += pb::CodedOutputStream.ComputeDoubleSize(10, CapitalOutSuper);
        }
        if (hasCapitalOutBig) {
      ...
      public sealed partial class Builder : pb::GeneratedBuilder<S2C, Builder> {
        ...
        public override Builder MergeFrom(S2C other) {
          ...
          if (other.HasCapitalInSuper) {
            CapitalInSuper = other.CapitalInSuper;
          }
          ...
          if (other.HasCapitalOutSuper) {
            CapitalOutSuper = other.CapitalOutSuper;
          }
        ...
        public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
          ...
          while (input.ReadTag(out tag, out field_name)) {
            ...
            switch (tag) {
              ...
              case 73: {
                result.hasCapitalInSuper = input.ReadDouble(ref result.capitalInSuper_);
                break;
              }
              case 81: {
                result.hasCapitalOutSuper = input.ReadDouble(ref result.capitalOutSuper_);
                break;
              }
            }
          }
        ...
        public bool HasCapitalInSuper {
          get { return result.hasCapitalInSuper; }
        }
        public double CapitalInSuper {
          get { return result.CapitalInSuper; }
          set { SetCapitalInSuper(value); }
        }
        public Builder SetCapitalInSuper(double value) {
          PrepareBuilder();
          result.hasCapitalInSuper = true;
          result.capitalInSuper_ = value;
          return this;
        }
        public Builder ClearCapitalInSuper() {
          PrepareBuilder();
          result.hasCapitalInSuper = false;
          result.capitalInSuper_ = 0D;
          return this;
        }
        ...
        public bool HasCapitalOutSuper {
          get { return result.hasCapitalOutSuper; }
        }
        public double CapitalOutSuper {
          get { return result.CapitalOutSuper; }
          set { SetCapitalOutSuper(value); }
        }
        public Builder SetCapitalOutSuper(double value) {
          PrepareBuilder();
          result.hasCapitalOutSuper = true;
          result.capitalOutSuper_ = value;
          return this;
        }
        public Builder ClearCapitalOutSuper() {
          PrepareBuilder();
          result.hasCapitalOutSuper = false;
          result.capitalOutSuper_ = 0D;
          return this;
        }
