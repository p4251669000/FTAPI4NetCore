...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class QotGetFutureInfo {
    ...
    static QotGetFutureInfo() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "FAoFYmVnaW4YASABKAFSBWJlZ2luEhAKA2VuZBgCIAEoAVIDZW5kIrQFCgpG", 
            ...
            "YW5nZUZvcm1hdFVybBIsCgZvcmlnaW4YEiABKAsyFC5Rb3RfQ29tbW9uLlNl", 
            "Y3VyaXR5UgZvcmlnaW4iPwoDQzJTEjgKDHNlY3VyaXR5TGlzdBgBIAMoCzIU", 
            "LlFvdF9Db21tb24uU2VjdXJpdHlSDHNlY3VyaXR5TGlzdCJMCgNTMkMSRQoO", 
            "ZnV0dXJlSW5mb0xpc3QYASADKAsyHS5Rb3RfR2V0RnV0dXJlSW5mby5GdXR1", 
            "cmVJbmZvUg5mdXR1cmVJbmZvTGlzdCIzCgdSZXF1ZXN0EigKA2MycxgBIAIo", 
            "CzIWLlFvdF9HZXRGdXR1cmVJbmZvLkMyU1IDYzJzIoYBCghSZXNwb25zZRIe", 
            "CgdyZXRUeXBlGAEgAigFOgQtNDAwUgdyZXRUeXBlEhYKBnJldE1zZxgCIAEo", 
            "CVIGcmV0TXNnEhgKB2VyckNvZGUYAyABKAVSB2VyckNvZGUSKAoDczJjGAQg", 
            "ASgLMhYuUW90X0dldEZ1dHVyZUluZm8uUzJDUgNzMmNCRwoTY29tLmZ1dHUu", 
            "b3BlbmFwaS5wYlowZ2l0aHViLmNvbS9mdXR1b3Blbi9mdGFwaTRnby9wYi9x", 
          "b3RnZXRmdXR1cmVpbmZv"));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Qot_GetFutureInfo_FutureInfo__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.QotGetFutureInfo.FutureInfo, global::Futu.OpenApi.Pb.QotGetFutureInfo.FutureInfo.Builder>(internal__static_Qot_GetFutureInfo_FutureInfo__Descriptor,
                new string[] { "Name", "Security", "LastTradeTime", "LastTradeTimestamp", "Owner", "OwnerOther", "Exchange", "ContractType", "ContractSize", "ContractSizeUnit", "QuoteCurrency", "MinVar", "MinVarUnit", "QuoteUnit", "TradeTime", "TimeZone", "ExchangeFormatUrl", "Origin", });
    ...
    public sealed partial class FutureInfo : pb::GeneratedMessage<FutureInfo, FutureInfo.Builder> {
      ...
      private static readonly string[] _futureInfoFieldNames = new string[] { "contractSize", "contractSizeUnit", "contractType", "exchange", "exchangeFormatUrl", "lastTradeTime", "lastTradeTimestamp", "minVar", "minVarUnit", "name", "origin", "owner", "ownerOther", "quoteCurrency", "quoteUnit", "security", "timeZone", "tradeTime" };
      private static readonly uint[] _futureInfoFieldTags = new uint[] { 73, 82, 66, 58, 138, 26, 33, 97, 106, 10, 146, 42, 50, 90, 114, 18, 130, 122 };
      ...
      public const int OriginFieldNumber = 18;
      private bool hasOrigin;
      private global::Futu.OpenApi.Pb.QotCommon.Security origin_;
      public bool HasOrigin {
        get { return hasOrigin; }
      }
      public global::Futu.OpenApi.Pb.QotCommon.Security Origin {
        get { return origin_ ?? global::Futu.OpenApi.Pb.QotCommon.Security.DefaultInstance; }
      }
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasSecurity) {
          output.WriteMessage(2, field_names[15], Security);
        }
        if (hasLastTradeTime) {
        ...
        if (hasOwner) {
          output.WriteMessage(5, field_names[11], Owner);
        }
        if (hasOwnerOther) {
          output.WriteString(6, field_names[12], OwnerOther);
        }
        if (hasExchange) {
        ...
        if (hasQuoteCurrency) {
          output.WriteString(11, field_names[13], QuoteCurrency);
        }
        if (hasMinVar) {
        ...
        if (hasQuoteUnit) {
          output.WriteString(14, field_names[14], QuoteUnit);
        }
        if (tradeTime_.Count > 0) {
          output.WriteMessageArray(15, field_names[17], tradeTime_);
        }
        if (hasTimeZone) {
          output.WriteString(16, field_names[16], TimeZone);
        }
        if (hasExchangeFormatUrl) {
          output.WriteString(17, field_names[4], ExchangeFormatUrl);
        }
        if (hasOrigin) {
          output.WriteMessage(18, field_names[10], Origin);
        }
        UnknownFields.WriteTo(output);
      }
      ...
      private int CalcSerializedSize() {
        ...
        if (hasOrigin) {
          size += pb::CodedOutputStream.ComputeMessageSize(18, Origin);
        }
        size += UnknownFields.SerializedSize;
        memoizedSerializedSize = size;
        return size;
      ...
      public sealed partial class Builder : pb::GeneratedBuilder<FutureInfo, Builder> {
        ...
        public Builder SetOrigin(global::Futu.OpenApi.Pb.QotCommon.Security value) {
          pb::ThrowHelper.ThrowIfNull(value, "value");
          PrepareBuilder();
        ...
        public Builder SetOrigin(global::Futu.OpenApi.Pb.QotCommon.Security.Builder builderForValue) {
          pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
          PrepareBuilder();
          result.hasOrigin = true;
        ...
        public Builder MergeOrigin(global::Futu.OpenApi.Pb.QotCommon.Security value) {
          pb::ThrowHelper.ThrowIfNull(value, "value");
          PrepareBuilder();
          if (result.hasOrigin &&
              result.origin_ != global::Futu.OpenApi.Pb.QotCommon.Security.DefaultInstance) {
              result.origin_ = global::Futu.OpenApi.Pb.QotCommon.Security.CreateBuilder(result.origin_).MergeFrom(value).BuildPartial();
          } else {
            result.origin_ = value;
          }
          result.hasOrigin = true;
