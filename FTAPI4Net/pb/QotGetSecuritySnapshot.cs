...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class QotGetSecuritySnapshot {
    ...
    static QotGetSecuritySnapshot() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "HgoKYXNzZXRDbGFzcxgGIAIoBVIKYXNzZXRDbGFzcyK7DAoRU25hcHNob3RC", 
            "YXNpY0RhdGESMAoIc2VjdXJpdHkYASACKAsyFC5Rb3RfQ29tbW9uLlNlY3Vy", 
            "aXR5UghzZWN1cml0eRISCgRuYW1lGCkgASgJUgRuYW1lEhIKBHR5cGUYAiAC", 
            "KAVSBHR5cGUSHAoJaXNTdXNwZW5kGAMgAigIUglpc1N1c3BlbmQSGgoIbGlz", 
            "dFRpbWUYBCACKAlSCGxpc3RUaW1lEhgKB2xvdFNpemUYBSACKAVSB2xvdFNp", 
            "emUSIAoLcHJpY2VTcHJlYWQYBiACKAFSC3ByaWNlU3ByZWFkEh4KCnVwZGF0", 
            "ZVRpbWUYByACKAlSCnVwZGF0ZVRpbWUSHAoJaGlnaFByaWNlGAggAigBUglo", 
            "aWdoUHJpY2USHAoJb3BlblByaWNlGAkgAigBUglvcGVuUHJpY2USGgoIbG93", 
            "UHJpY2UYCiACKAFSCGxvd1ByaWNlEiYKDmxhc3RDbG9zZVByaWNlGAsgAigB", 
            "Ug5sYXN0Q2xvc2VQcmljZRIaCghjdXJQcmljZRgMIAIoAVIIY3VyUHJpY2US", 
            "FgoGdm9sdW1lGA0gAigDUgZ2b2x1bWUSGgoIdHVybm92ZXIYDiACKAFSCHR1", 
            "cm5vdmVyEiIKDHR1cm5vdmVyUmF0ZRgPIAIoAVIMdHVybm92ZXJSYXRlEiQK", 
            "DWxpc3RUaW1lc3RhbXAYECABKAFSDWxpc3RUaW1lc3RhbXASKAoPdXBkYXRl", 
            "VGltZXN0YW1wGBEgASgBUg91cGRhdGVUaW1lc3RhbXASGgoIYXNrUHJpY2UY", 
            "EiABKAFSCGFza1ByaWNlEhoKCGJpZFByaWNlGBMgASgBUghiaWRQcmljZRIW", 
            "CgZhc2tWb2wYFCABKANSBmFza1ZvbBIWCgZiaWRWb2wYFSABKANSBmJpZFZv", 
            "bBIiCgxlbmFibGVNYXJnaW4YFiABKAhSDGVuYWJsZU1hcmdpbhIkCg1tb3J0", 
            "Z2FnZVJhdGlvGBcgASgBUg1tb3J0Z2FnZVJhdGlvEjYKFmxvbmdNYXJnaW5J", 
            "bml0aWFsUmF0aW8YGCABKAFSFmxvbmdNYXJnaW5Jbml0aWFsUmF0aW8SKAoP", 
            "ZW5hYmxlU2hvcnRTZWxsGBkgASgIUg9lbmFibGVTaG9ydFNlbGwSJAoNc2hv", 
            "cnRTZWxsUmF0ZRgaIAEoAVINc2hvcnRTZWxsUmF0ZRIyChRzaG9ydEF2YWls", 
            "YWJsZVZvbHVtZRgbIAEoA1IUc2hvcnRBdmFpbGFibGVWb2x1bWUSOAoXc2hv", 
            "cnRNYXJnaW5Jbml0aWFsUmF0aW8YHCABKAFSF3Nob3J0TWFyZ2luSW5pdGlh", 
            "bFJhdGlvEhwKCWFtcGxpdHVkZRgdIAEoAVIJYW1wbGl0dWRlEhoKCGF2Z1By", 
            "aWNlGB4gASgBUghhdmdQcmljZRIgCgtiaWRBc2tSYXRpbxgfIAEoAVILYmlk", 
            "QXNrUmF0aW8SIAoLdm9sdW1lUmF0aW8YICABKAFSC3ZvbHVtZVJhdGlvEjAK", 
            "E2hpZ2hlc3Q1MldlZWtzUHJpY2UYISABKAFSE2hpZ2hlc3Q1MldlZWtzUHJp", 
            "Y2USLgoSbG93ZXN0NTJXZWVrc1ByaWNlGCIgASgBUhJsb3dlc3Q1MldlZWtz", 
            "UHJpY2USMAoTaGlnaGVzdEhpc3RvcnlQcmljZRgjIAEoAVITaGlnaGVzdEhp", 
            "c3RvcnlQcmljZRIuChJsb3dlc3RIaXN0b3J5UHJpY2UYJCABKAFSEmxvd2Vz", 
            "dEhpc3RvcnlQcmljZRI8CglwcmVNYXJrZXQYJSABKAsyHi5Rb3RfQ29tbW9u", 
            "LlByZUFmdGVyTWFya2V0RGF0YVIJcHJlTWFya2V0EkAKC2FmdGVyTWFya2V0", 
            "GCYgASgLMh4uUW90X0NvbW1vbi5QcmVBZnRlck1hcmtldERhdGFSC2FmdGVy", 
            "TWFya2V0EhwKCXNlY1N0YXR1cxgnIAEoBVIJc2VjU3RhdHVzEiwKEWNsb3Nl", 
            "UHJpY2U1TWludXRlGCggASgBUhFjbG9zZVByaWNlNU1pbnV0ZRI8CglvdmVy", 
            "bmlnaHQYKiABKAsyHi5Rb3RfQ29tbW9uLlByZUFmdGVyTWFya2V0RGF0YVIJ", 
            "b3Zlcm5pZ2h0IosFCghTbmFwc2hvdBJACgViYXNpYxgBIAIoCzIqLlFvdF9H", 
            "ZXRTZWN1cml0eVNuYXBzaG90LlNuYXBzaG90QmFzaWNEYXRhUgViYXNpYxJR", 
            "CgxlcXVpdHlFeERhdGEYAiABKAsyLS5Rb3RfR2V0U2VjdXJpdHlTbmFwc2hv", 
            "dC5FcXVpdHlTbmFwc2hvdEV4RGF0YVIMZXF1aXR5RXhEYXRhElQKDXdhcnJh", 
            "bnRFeERhdGEYAyABKAsyLi5Rb3RfR2V0U2VjdXJpdHlTbmFwc2hvdC5XYXJy", 
            "YW50U25hcHNob3RFeERhdGFSDXdhcnJhbnRFeERhdGESUQoMb3B0aW9uRXhE", 
            "YXRhGAQgASgLMi0uUW90X0dldFNlY3VyaXR5U25hcHNob3QuT3B0aW9uU25h", 
            "cHNob3RFeERhdGFSDG9wdGlvbkV4RGF0YRJOCgtpbmRleEV4RGF0YRgFIAEo", 
            "CzIsLlFvdF9HZXRTZWN1cml0eVNuYXBzaG90LkluZGV4U25hcHNob3RFeERh", 
            "dGFSC2luZGV4RXhEYXRhEk4KC3BsYXRlRXhEYXRhGAYgASgLMiwuUW90X0dl", 
            "dFNlY3VyaXR5U25hcHNob3QuUGxhdGVTbmFwc2hvdEV4RGF0YVILcGxhdGVF", 
            "eERhdGESUQoMZnV0dXJlRXhEYXRhGAcgASgLMi0uUW90X0dldFNlY3VyaXR5", 
            "U25hcHNob3QuRnV0dXJlU25hcHNob3RFeERhdGFSDGZ1dHVyZUV4RGF0YRJO", 
            "Cgt0cnVzdEV4RGF0YRgIIAEoCzIsLlFvdF9HZXRTZWN1cml0eVNuYXBzaG90", 
            "LlRydXN0U25hcHNob3RFeERhdGFSC3RydXN0RXhEYXRhIkwKA1MyQxJFCgxz", 
            "bmFwc2hvdExpc3QYASADKAsyIS5Rb3RfR2V0U2VjdXJpdHlTbmFwc2hvdC5T", 
            "bmFwc2hvdFIMc25hcHNob3RMaXN0IjkKB1JlcXVlc3QSLgoDYzJzGAEgAigL", 
            "MhwuUW90X0dldFNlY3VyaXR5U25hcHNob3QuQzJTUgNjMnMijAEKCFJlc3Bv", 
            "bnNlEh4KB3JldFR5cGUYASACKAU6BC00MDBSB3JldFR5cGUSFgoGcmV0TXNn", 
            "GAIgASgJUgZyZXRNc2cSGAoHZXJyQ29kZRgDIAEoBVIHZXJyQ29kZRIuCgNz", 
            "MmMYBCABKAsyHC5Rb3RfR2V0U2VjdXJpdHlTbmFwc2hvdC5TMkNSA3MyY0JN", 
            "ChNjb20uZnV0dS5vcGVuYXBpLnBiWjZnaXRodWIuY29tL2Z1dHVvcGVuL2Z0", 
          "YXBpNGdvL3BiL3FvdGdldHNlY3VyaXR5c25hcHNob3Q="));
    ...
    public sealed partial class SnapshotBasicData : pb::GeneratedMessage<SnapshotBasicData, SnapshotBasicData.Builder> {
      ...
      private static readonly string[] _snapshotBasicDataFieldNames = new string[] { "afterMarket", "amplitude", "askPrice", "askVol", "avgPrice", "bidAskRatio", "bidPrice", "bidVol", "closePrice5Minute", "curPrice", "enableMargin", "enableShortSell", "highPrice", "highest52WeeksPrice", "highestHistoryPrice", "isSuspend", "lastClosePrice", "listTime", "listTimestamp", "longMarginInitialRatio", "lotSize", "lowPrice", "lowest52WeeksPrice", "lowestHistoryPrice", "mortgageRatio", "name", "openPrice", "overnight", "preMarket", "priceSpread", "secStatus", "security", "shortAvailableVolume", "shortMarginInitialRatio", "shortSellRate", "turnover", "turnoverRate", "type", "updateTime", "updateTimestamp", "volume", "volumeRatio" };
      private static readonly uint[] _snapshotBasicDataFieldTags = new uint[] { 306, 233, 145, 160, 241, 249, 153, 168, 321, 97, 176, 200, 65, 265, 281, 24, 89, 34, 129, 193, 40, 81, 273, 289, 185, 330, 73, 338, 298, 49, 312, 10, 216, 225, 209, 113, 121, 16, 58, 137, 104, 257 };
      ...
      public const int NameFieldNumber = 41;
      ...
      public const int OvernightFieldNumber = 42;
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasSecurity) {
          output.WriteMessage(1, field_names[31], Security);
        }
        if (hasType) {
          output.WriteInt32(2, field_names[37], Type);
        }
        if (hasIsSuspend) {
        ...
        if (hasPriceSpread) {
          output.WriteDouble(6, field_names[29], PriceSpread);
        }
        if (hasUpdateTime) {
          output.WriteString(7, field_names[38], UpdateTime);
        }
        if (hasHighPrice) {
          output.WriteDouble(8, field_names[12], HighPrice);
        }
        if (hasOpenPrice) {
          output.WriteDouble(9, field_names[26], OpenPrice);
        }
        if (hasLowPrice) {
        ...
        if (hasVolume) {
          output.WriteInt64(13, field_names[40], Volume);
        }
        if (hasTurnover) {
          output.WriteDouble(14, field_names[35], Turnover);
        }
        if (hasTurnoverRate) {
          output.WriteDouble(15, field_names[36], TurnoverRate);
        }
        if (hasListTimestamp) {
          output.WriteDouble(16, field_names[18], ListTimestamp);
        }
        if (hasUpdateTimestamp) {
          output.WriteDouble(17, field_names[39], UpdateTimestamp);
        }
        if (hasAskPrice) {
        ...
        if (hasShortSellRate) {
          output.WriteDouble(26, field_names[34], ShortSellRate);
        }
        if (hasShortAvailableVolume) {
          output.WriteInt64(27, field_names[32], ShortAvailableVolume);
        }
        if (hasShortMarginInitialRatio) {
          output.WriteDouble(28, field_names[33], ShortMarginInitialRatio);
        }
        if (hasAmplitude) {
        ...
        if (hasVolumeRatio) {
          output.WriteDouble(32, field_names[41], VolumeRatio);
        }
        ...
        if (hasPreMarket) {
          output.WriteMessage(37, field_names[28], PreMarket);
        }
        if (hasAfterMarket) {
          output.WriteMessage(38, field_names[0], AfterMarket);
        }
        if (hasSecStatus) {
          output.WriteInt32(39, field_names[30], SecStatus);
        }
        if (hasClosePrice5Minute) {
          output.WriteDouble(40, field_names[8], ClosePrice5Minute);
        }
        if (hasName) {
          output.WriteString(41, field_names[25], Name);
        }
        if (hasOvernight) {
          output.WriteMessage(42, field_names[27], Overnight);
        }
        UnknownFields.WriteTo(output);
      }
      ...
      private int CalcSerializedSize() {
        ...
        if (hasName) {
          size += pb::CodedOutputStream.ComputeStringSize(41, Name);
        }
        if (hasType) {
        ...
        if (hasOvernight) {
          size += pb::CodedOutputStream.ComputeMessageSize(42, Overnight);
        }
        size += UnknownFields.SerializedSize;
        memoizedSerializedSize = size;
        return size;
