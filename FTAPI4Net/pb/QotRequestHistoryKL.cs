...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class QotRequestHistoryKL {
    ...
    static QotRequestHistoryKL() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "b3J5S0waDENvbW1vbi5wcm90bxoQUW90X0NvbW1vbi5wcm90byLRAgoDQzJT", 
            ...
            "EiIKDGV4dGVuZGVkVGltZRgJIAEoCFIMZXh0ZW5kZWRUaW1lEhgKB3Nlc3Np", 
            "b24YCiABKAVSB3Nlc3Npb24ilgEKA1MyQxIwCghzZWN1cml0eRgBIAIoCzIU", 
            "LlFvdF9Db21tb24uU2VjdXJpdHlSCHNlY3VyaXR5EhIKBG5hbWUYBCABKAlS", 
            "BG5hbWUSKQoGa2xMaXN0GAIgAygLMhEuUW90X0NvbW1vbi5LTGluZVIGa2xM", 
            "aXN0Eh4KCm5leHRSZXFLZXkYAyABKAxSCm5leHRSZXFLZXkiNgoHUmVxdWVz", 
            "dBIrCgNjMnMYASACKAsyGS5Rb3RfUmVxdWVzdEhpc3RvcnlLTC5DMlNSA2My", 
            "cyKJAQoIUmVzcG9uc2USHgoHcmV0VHlwZRgBIAIoBToELTQwMFIHcmV0VHlw", 
            "ZRIWCgZyZXRNc2cYAiABKAlSBnJldE1zZxIYCgdlcnJDb2RlGAMgASgFUgdl", 
            "cnJDb2RlEisKA3MyYxgEIAEoCzIZLlFvdF9SZXF1ZXN0SGlzdG9yeUtMLlMy", 
            "Q1IDczJjQkoKE2NvbS5mdXR1Lm9wZW5hcGkucGJaM2dpdGh1Yi5jb20vZnV0", 
          "dW9wZW4vZnRhcGk0Z28vcGIvcW90cmVxdWVzdGhpc3RvcnlrbA=="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Qot_RequestHistoryKL_C2S__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.QotRequestHistoryKL.C2S, global::Futu.OpenApi.Pb.QotRequestHistoryKL.C2S.Builder>(internal__static_Qot_RequestHistoryKL_C2S__Descriptor,
                new string[] { "RehabType", "KlType", "Security", "BeginTime", "EndTime", "MaxAckKLNum", "NeedKLFieldsFlag", "NextReqKey", "ExtendedTime", "Session", });
        ...
        internal__static_Qot_RequestHistoryKL_S2C__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.QotRequestHistoryKL.S2C, global::Futu.OpenApi.Pb.QotRequestHistoryKL.S2C.Builder>(internal__static_Qot_RequestHistoryKL_S2C__Descriptor,
                new string[] { "Security", "Name", "KlList", "NextReqKey", });
    ...
    public sealed partial class C2S : pb::GeneratedMessage<C2S, C2S.Builder> {
      ...
      private static readonly string[] _c2SFieldNames = new string[] { "beginTime", "endTime", "extendedTime", "klType", "maxAckKLNum", "needKLFieldsFlag", "nextReqKey", "rehabType", "security", "session" };
      private static readonly uint[] _c2SFieldTags = new uint[] { 34, 42, 72, 16, 48, 56, 66, 8, 26, 80 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasSession) {
          output.WriteInt32(10, field_names[9], Session);
        }
    ...
    public sealed partial class S2C : pb::GeneratedMessage<S2C, S2C.Builder> {
      ...
      private static readonly string[] _s2CFieldNames = new string[] { "klList", "name", "nextReqKey", "security" };
      private static readonly uint[] _s2CFieldTags = new uint[] { 18, 34, 26, 10 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasNextReqKey) {
          output.WriteBytes(3, field_names[2], NextReqKey);
        }
        if (hasName) {
