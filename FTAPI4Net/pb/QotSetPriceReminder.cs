...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class QotSetPriceReminder {
    ...
    static QotSetPriceReminder() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "aW5kZXIaDENvbW1vbi5wcm90bxoQUW90X0NvbW1vbi5wcm90byLdAQoDQzJT", 
            ...
            "IAEoAVIFdmFsdWUSEgoEbm90ZRgGIAEoCVIEbm90ZRIwChNyZW1pbmRlclNl", 
            "c3Npb25MaXN0GAggAygFUhNyZW1pbmRlclNlc3Npb25MaXN0IhcKA1MyQxIQ", 
            "CgNrZXkYASACKANSA2tleSI2CgdSZXF1ZXN0EisKA2MycxgBIAIoCzIZLlFv", 
            "dF9TZXRQcmljZVJlbWluZGVyLkMyU1IDYzJzIokBCghSZXNwb25zZRIeCgdy", 
            "ZXRUeXBlGAEgAigFOgQtNDAwUgdyZXRUeXBlEhYKBnJldE1zZxgCIAEoCVIG", 
            "cmV0TXNnEhgKB2VyckNvZGUYAyABKAVSB2VyckNvZGUSKwoDczJjGAQgASgL", 
            "MhkuUW90X1NldFByaWNlUmVtaW5kZXIuUzJDUgNzMmMq6QEKElNldFByaWNl", 
            "UmVtaW5kZXJPcBIeChpTZXRQcmljZVJlbWluZGVyT3BfVW5rbm93bhAAEhoK", 
            "FlNldFByaWNlUmVtaW5kZXJPcF9BZGQQARIaChZTZXRQcmljZVJlbWluZGVy", 
            "T3BfRGVsEAISHQoZU2V0UHJpY2VSZW1pbmRlck9wX0VuYWJsZRADEh4KGlNl", 
            "dFByaWNlUmVtaW5kZXJPcF9EaXNhYmxlEAQSHQoZU2V0UHJpY2VSZW1pbmRl", 
            "ck9wX01vZGlmeRAFEh0KGVNldFByaWNlUmVtaW5kZXJPcF9EZWxBbGwQBkJK", 
            "ChNjb20uZnV0dS5vcGVuYXBpLnBiWjNnaXRodWIuY29tL2Z1dHVvcGVuL2Z0", 
          "YXBpNGdvL3BiL3FvdHNldHByaWNlcmVtaW5kZXI="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Qot_SetPriceReminder_C2S__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.QotSetPriceReminder.C2S, global::Futu.OpenApi.Pb.QotSetPriceReminder.C2S.Builder>(internal__static_Qot_SetPriceReminder_C2S__Descriptor,
                new string[] { "Security", "Op", "Key", "Type", "Freq", "Value", "Note", "ReminderSessionList", });
    ...
    public sealed partial class C2S : pb::GeneratedMessage<C2S, C2S.Builder> {
      ...
      private static readonly string[] _c2SFieldNames = new string[] { "freq", "key", "note", "op", "reminderSessionList", "security", "type", "value" };
      private static readonly uint[] _c2SFieldTags = new uint[] { 56, 24, 50, 16, 64, 10, 32, 41 };
      ...
      public const int ReminderSessionListFieldNumber = 8;
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasType) {
          output.WriteInt32(4, field_names[6], Type);
        }
        if (hasValue) {
          output.WriteDouble(5, field_names[7], Value);
        }
        if (hasNote) {
        ...
        if (reminderSessionList_.Count > 0) {
          output.WriteInt32Array(8, field_names[4], reminderSessionList_);
        }
