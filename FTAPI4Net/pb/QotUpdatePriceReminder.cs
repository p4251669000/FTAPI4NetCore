...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class QotUpdatePriceReminder {
    ...
    static QotUpdatePriceReminder() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "aWNlUmVtaW5kZXIaDENvbW1vbi5wcm90bxoQUW90X0NvbW1vbi5wcm90byKx", 
            "AgoDUzJDEjAKCHNlY3VyaXR5GAEgAigLMhQuUW90X0NvbW1vbi5TZWN1cml0", 
            "eVIIc2VjdXJpdHkSEgoEbmFtZRgLIAEoCVIEbmFtZRIUCgVwcmljZRgCIAIo", 
            "AVIFcHJpY2USHgoKY2hhbmdlUmF0ZRgDIAIoAVIKY2hhbmdlUmF0ZRIiCgxt", 
            "YXJrZXRTdGF0dXMYBCACKAVSDG1hcmtldFN0YXR1cxIYCgdjb250ZW50GAUg", 
            "AigJUgdjb250ZW50EhIKBG5vdGUYBiACKAlSBG5vdGUSEAoDa2V5GAcgASgD", 
            "UgNrZXkSEgoEdHlwZRgIIAEoBVIEdHlwZRIaCghzZXRWYWx1ZRgJIAEoAVII", 
            "c2V0VmFsdWUSGgoIY3VyVmFsdWUYCiABKAFSCGN1clZhbHVlIowBCghSZXNw", 
            "b25zZRIeCgdyZXRUeXBlGAEgAigFOgQtNDAwUgdyZXRUeXBlEhYKBnJldE1z", 
            "ZxgCIAEoCVIGcmV0TXNnEhgKB2VyckNvZGUYAyABKAVSB2VyckNvZGUSLgoD", 
            "czJjGAQgASgLMhwuUW90X1VwZGF0ZVByaWNlUmVtaW5kZXIuUzJDUgNzMmNC", 
            "TQoTY29tLmZ1dHUub3BlbmFwaS5wYlo2Z2l0aHViLmNvbS9mdXR1b3Blbi9m", 
          "dGFwaTRnby9wYi9xb3R1cGRhdGVwcmljZXJlbWluZGVy"));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Qot_UpdatePriceReminder_S2C__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.QotUpdatePriceReminder.S2C, global::Futu.OpenApi.Pb.QotUpdatePriceReminder.S2C.Builder>(internal__static_Qot_UpdatePriceReminder_S2C__Descriptor,
                new string[] { "Security", "Name", "Price", "ChangeRate", "MarketStatus", "Content", "Note", "Key", "Type", "SetValue", "CurValue", });
    ...
    public sealed partial class S2C : pb::GeneratedMessage<S2C, S2C.Builder> {
      ...
      private static readonly string[] _s2CFieldNames = new string[] { "changeRate", "content", "curValue", "key", "marketStatus", "name", "note", "price", "security", "setValue", "type" };
      private static readonly uint[] _s2CFieldTags = new uint[] { 25, 42, 81, 56, 32, 90, 50, 17, 10, 73, 64 };
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasPrice) {
          output.WriteDouble(2, field_names[7], Price);
        }
        if (hasChangeRate) {
        ...
        if (hasNote) {
          output.WriteString(6, field_names[6], Note);
        }
        if (hasKey) {
          output.WriteInt64(7, field_names[3], Key);
        }
        if (hasType) {
          output.WriteInt32(8, field_names[10], Type);
        }
        if (hasSetValue) {
          output.WriteDouble(9, field_names[9], SetValue);
        }
        if (hasCurValue) {
          output.WriteDouble(10, field_names[2], CurValue);
        }
        if (hasName) {
          output.WriteString(11, field_names[5], Name);
        }
      ...
      private int CalcSerializedSize() {
        ...
        if (hasName) {
          size += pb::CodedOutputStream.ComputeStringSize(11, Name);
        }
        if (hasPrice) {
