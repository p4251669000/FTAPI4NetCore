...
namespace Futu.OpenApi.Pb {
  ...
  public static partial class TrdPlaceOrder {
    ...
    static TrdPlaceOrder() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bi5wcm90bxoQVHJkX0NvbW1vbi5wcm90byK+BAoDQzJTEiwKCHBhY2tldElE", 
            ...
            "VEgSGgoIYXV4UHJpY2UYDiABKAFSCGF1eFByaWNlEhwKCXRyYWlsVHlwZRgP", 
            "IAEoBVIJdHJhaWxUeXBlEh4KCnRyYWlsVmFsdWUYECABKAFSCnRyYWlsVmFs", 
            "dWUSIAoLdHJhaWxTcHJlYWQYESABKAFSC3RyYWlsU3ByZWFkEhgKB3Nlc3Np", 
            "b24YEiABKAVSB3Nlc3Npb24ibAoDUzJDEi0KBmhlYWRlchgBIAIoCzIVLlRy", 
            "ZF9Db21tb24uVHJkSGVhZGVyUgZoZWFkZXISGAoHb3JkZXJJRBgCIAEoBFIH", 
            "b3JkZXJJRBIcCglvcmRlcklERXgYAyABKAlSCW9yZGVySURFeCIwCgdSZXF1", 
      ...
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Trd_PlaceOrder_C2S__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Futu.OpenApi.Pb.TrdPlaceOrder.C2S, global::Futu.OpenApi.Pb.TrdPlaceOrder.C2S.Builder>(internal__static_Trd_PlaceOrder_C2S__Descriptor,
                new string[] { "PacketID", "Header", "TrdSide", "OrderType", "Code", "Qty", "Price", "AdjustPrice", "AdjustSideAndLimit", "SecMarket", "Remark", "TimeInForce", "FillOutsideRTH", "AuxPrice", "TrailType", "TrailValue", "TrailSpread", "Session", });
    ...
    public sealed partial class C2S : pb::GeneratedMessage<C2S, C2S.Builder> {
      ...
      private static readonly string[] _c2SFieldNames = new string[] { "adjustPrice", "adjustSideAndLimit", "auxPrice", "code", "fillOutsideRTH", "header", "orderType", "packetID", "price", "qty", "remark", "secMarket", "session", "timeInForce", "trailSpread", "trailType", "trailValue", "trdSide" };
      private static readonly uint[] _c2SFieldTags = new uint[] { 64, 73, 113, 42, 104, 18, 32, 10, 57, 49, 90, 80, 144, 96, 137, 120, 129, 24 };
      ...
      public const int AuxPriceFieldNumber = 14;
      ...
      public const int TrailTypeFieldNumber = 15;
      ...
      public const int TrailValueFieldNumber = 16;
      ...
      public const int TrailSpreadFieldNumber = 17;
      ...
      public const int SessionFieldNumber = 18;
      ...
      public override void WriteTo(pb::ICodedOutputStream output) {
        ...
        if (hasPacketID) {
          output.WriteMessage(1, field_names[7], PacketID);
        }
        if (hasHeader) {
          output.WriteMessage(2, field_names[5], Header);
        }
        if (hasTrdSide) {
          output.WriteInt32(3, field_names[17], TrdSide);
        }
        if (hasOrderType) {
          output.WriteInt32(4, field_names[6], OrderType);
        }
        if (hasCode) {
          output.WriteString(5, field_names[3], Code);
        }
        if (hasQty) {
          output.WriteDouble(6, field_names[9], Qty);
        }
        if (hasPrice) {
        ...
        if (hasSecMarket) {
          output.WriteInt32(10, field_names[11], SecMarket);
        }
        if (hasRemark) {
          output.WriteString(11, field_names[10], Remark);
        }
        if (hasTimeInForce) {
          output.WriteInt32(12, field_names[13], TimeInForce);
        }
        if (hasFillOutsideRTH) {
          output.WriteBool(13, field_names[4], FillOutsideRTH);
        }
        if (hasAuxPrice) {
          output.WriteDouble(14, field_names[2], AuxPrice);
        }
        if (hasTrailType) {
          output.WriteInt32(15, field_names[15], TrailType);
        }
        if (hasTrailValue) {
          output.WriteDouble(16, field_names[16], TrailValue);
        }
        if (hasTrailSpread) {
          output.WriteDouble(17, field_names[14], TrailSpread);
        }
        if (hasSession) {
          output.WriteInt32(18, field_names[12], Session);
        }
      ...
      private int CalcSerializedSize() {
        ...
        if (hasAuxPrice) {
          size += pb::CodedOutputStream.ComputeDoubleSize(14, AuxPrice);
        }
        if (hasTrailType) {
          size += pb::CodedOutputStream.ComputeInt32Size(15, TrailType);
        }
        if (hasTrailValue) {
          size += pb::CodedOutputStream.ComputeDoubleSize(16, TrailValue);
        }
        if (hasTrailSpread) {
          size += pb::CodedOutputStream.ComputeDoubleSize(17, TrailSpread);
        }
        if (hasSession) {
          size += pb::CodedOutputStream.ComputeInt32Size(18, Session);
        }
